(function() {
  ...
  this.Metalive.EventView = (function() {
    function EventView(target, current) {
      ...
      this.template = "<p class='event'> <img class='cover' src='{{ description.cover }}'> <span class='title'>{{ description.title }}</span> par&nbsp;<span class='artist'>{{ description.artist }}</span> sur&nbsp;l'album&nbsp;<span class='album'>{{ description.album }}</span> <span class='since'>{{ description.distance_from_now }}</span> </p>";
    }
